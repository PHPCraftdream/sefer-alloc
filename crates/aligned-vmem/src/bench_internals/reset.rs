...
/// `bench-internals`: reset all sixteen counters (`UNIX_EXACT_RESERVE_ATTEMPTS`,
...
/// `WINDOWS_VIRTUALFREE_RELEASE_ATTEMPTS`,
...
pub fn reset_bench_internals_counters() {
    ...
    UNIX_MUNMAP_ATTEMPTS.store(0, Ordering::Relaxed);
    ...
    WINDOWS_VIRTUALFREE_RELEASE_ATTEMPTS.store(0, Ordering::Relaxed);
