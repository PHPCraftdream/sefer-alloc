...
/// argument of [`reserve_aligned_lazy`] — i.e. whether "lazy" is real here.
///
...
/// [`Reservation::decommit_reclaims_and_zeroes`] and [`Reservation::is_huge`]:
...
///
/// [`LazyReservation`] consults this internally, so its
/// [`committed_len`](LazyReservation::committed_len) is already the platform
...
impl LazyReservation {
    ...
    fn new(inner: Reservation, initial_commit: usize) -> Self {
