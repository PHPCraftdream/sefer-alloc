...
//!   `ReservedSmallSegment` handle (`src/alloc_core/small/reserved_small_segment.rs`)
...
//!   layer. See `src/alloc_core/small/reserved_small_segment.rs`'s module doc
...
/// the crate root, e.g. `src/alloc_core/alloc_core/alloc_core_core_diag/totals.rs`.
...
const PURE_OBSERVERS: &[&str] = &[
    ...
    "src/alloc_core/alloc_core/alloc_core_core_diag/perf_diag.rs::dbg_dirty_segments_drained",
    "src/alloc_core/alloc_core/alloc_core_core_diag/perf_diag.rs::dbg_wasted_dirty_drains",
    ...
    "src/alloc_core/alloc_core/alloc_core_core_diag/directory_diag.rs::dbg_sidecar_oom_latch",
    ...
    "src/alloc_core/large/alloc_core_large_cache.rs::dbg_decay_config",
    "src/alloc_core/large/alloc_core_large_cache.rs::dbg_large_cache_used",
    "src/alloc_core/large/alloc_core_large_cache.rs::dbg_large_cache_hits",
    "src/alloc_core/large/alloc_core_large_cache.rs::dbg_large_cache_slot_sizes",
    ...
    "src/registry/heap_core/diag/queries.rs::dbg_sidecar_oom_latch",
...
const SAFE_MUTATORS: &[(&str, &str)] = &[
    ...
    (
        "src/alloc_core/small/alloc_core_small_reclaim.rs::dbg_force_coarse_dirty_bit_for",
    ...
    (
        "src/alloc_core/segment/remote_free_ring/ops.rs::dbg_advance_head_only",
    ...
    (
        "src/registry/heap_core/diag/queries.rs::dbg_drain_all_rings",
        "delegates to AllocCore's real production drain over table-owned bases only",
    ),
    (
        "src/registry/heap_core/diag/queries.rs::dbg_force_sidecar_oom_latch",
...
const UNSAFE_HOOKS: &[&str] = &[
    ...
    "src/registry/heap_core_xthread/overflow.rs::dbg_resolve_dirty_notification",
    ...
    "src/registry/heap_core/diag/queries.rs::dbg_push_coarse_only_entry",
