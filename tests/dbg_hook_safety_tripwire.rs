...
const PURE_OBSERVERS: &[&str] = &[
    ...
    "src/alloc_core/alloc_core_core_diag.rs::dbg_reloc_inplace_large_count",
    "src/alloc_core/alloc_core_core_diag.rs::dbg_reloc_inplace_small_count",
    "src/alloc_core/alloc_core_core_diag.rs::dbg_reloc_fastpath_decline_count",
