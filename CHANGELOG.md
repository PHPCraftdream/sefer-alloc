...
### Round 30 — fixed a CONFIRMED soundness hazard a post-round R29 review flagged the same day it landed: a safe `pub fn` measurement hook could dangle the live small-segment bump-carve cursor (R30-1, task #450)
