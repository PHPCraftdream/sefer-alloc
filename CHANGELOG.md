...
The `#714` (F3) and `#711`/`#718`-diagnosis (F4/F5) CHANGELOG-accuracy findings, plus F2 (`mock`'s fabricated OS code) and F6-F15, are tracked in task #776, not yet closed as of this entry.
