...
//! = 0` (the most aggressive reclamation arm — decay can release everything
//! down to zero). One of four near-identical sibling binaries
...
//!
//! ```text
//! cargo build --release --example r30_6_latency_h0 --features "production alloc-stats"
//! ./target/release/examples/r30_6_latency_h0.exe
//! ```
//!
