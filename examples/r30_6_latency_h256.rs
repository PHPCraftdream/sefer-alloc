...
//! = 256 MiB` (the shipped default). One of four near-identical sibling binaries
...
//!
//! ```text
//! cargo build --release --example r30_6_latency_h256 --features "production alloc-stats"
//! ./target/release/examples/r30_6_latency_h256.exe
//! ```
//!
...
const HEADROOM_BYTES: usize = 256 * 1024 * 1024;
