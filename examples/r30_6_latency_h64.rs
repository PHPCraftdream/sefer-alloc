...
//! = 64 MiB`. One of four near-identical sibling binaries
...
//!
//! ```text
//! cargo build --release --example r30_6_latency_h64 --features "production alloc-stats"
//! ./target/release/examples/r30_6_latency_h64.exe
//! ```
//!
...
const HEADROOM_BYTES: usize = 64 * 1024 * 1024;
