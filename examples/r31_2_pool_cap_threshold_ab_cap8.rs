...
//! **cap8** (`pool_segments=8, pool_byte_cap=32 MiB` — `Profile::Throughput`'s
//! current small-pool value).
//!
...
const POOL_BYTE_CAP: usize = 32 * 1024 * 1024;
...
fn main() {
    run_arm("cap8", &GLOBAL, POOL_SEGMENTS as u64, POOL_BYTE_CAP as u64);
}
