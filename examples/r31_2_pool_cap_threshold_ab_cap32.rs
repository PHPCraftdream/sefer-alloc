...
//! **cap32** (`pool_segments=32, pool_byte_cap=128 MiB`).
//!
...
const POOL_SEGMENTS: usize = 32;
const POOL_BYTE_CAP: usize = 128 * 1024 * 1024;
...
fn main() {
    run_arm("cap32", &GLOBAL, POOL_SEGMENTS as u64, POOL_BYTE_CAP as u64);
}
