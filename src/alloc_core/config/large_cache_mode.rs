...
//! private helpers — referenced by [`LargeCacheConfig`](crate::alloc_core::config::large_cache_config::LargeCacheConfig)
...
///
/// [`LargeCacheConfig::mode`]: crate::alloc_core::config::large_cache_config::LargeCacheConfig::mode
