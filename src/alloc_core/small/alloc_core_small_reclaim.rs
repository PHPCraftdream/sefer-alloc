...
impl AllocCore {
    ...
    pub(crate) fn reclaim_offset_checked<F: Fn(*mut u8, usize) -> bool>(
        ...
        let (stamped_gen, class_idx_raw, off_raw) =
            crate::alloc_core::remote_free_ring::unpack_entry_hardened(packed);
        #[cfg(not(feature = "hardened"))]
        let (off_raw, class_idx_raw) = crate::alloc_core::remote_free_ring::unpack_entry(packed);
        ...
        #[cfg(feature = "hardened")]
        {
            ...
            #[allow(unsafe_code)]
            let current_gen = unsafe { crate::alloc_core::segment_header::gen_at(base, off) };
