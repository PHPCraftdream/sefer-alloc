...
impl SegmentLayout {
    ...
    pub const PAGES_PER_SEGMENT: usize = crate::alloc_core::segment_header::PAGES_PER_SEGMENT;

    /// The minimum block size and fundamental small-class alignment (16 B).
    pub const MIN_BLOCK: usize = crate::alloc_core::size_classes::MIN_BLOCK;
    ...
    pub const MIN_BLOCK_SHIFT: u32 = crate::alloc_core::size_classes::MIN_BLOCK_SHIFT;
    ...
    pub const SMALL_ALIGN_MAX: usize = crate::alloc_core::size_classes::SMALL_ALIGN_MAX;
    ...
    pub const SMALL_MAX: usize = crate::alloc_core::size_classes::SMALL_MAX;
    ...
    pub const SIZE_CLASS_TABLE: &'static [usize] =
        &crate::alloc_core::size_classes::SIZE_CLASS_TABLE;
    ...
    pub const SIZE2CLASS: &'static [u8] = &crate::alloc_core::size_classes::SIZE2CLASS;
    ...
    pub const fn try_class_for(
        ...
        crate::alloc_core::size_classes::SizeClasses::try_class_for(size, align)
    }
    ...
    pub const fn segment_base_of(addr: usize) -> usize {
        crate::alloc_core::os::segment_base_of(addr)
    }
}
