...
use crate::alloc_core::segment_header::{Layout, GEN_TABLE_FOOTPRINT};
use crate::alloc_core::size_classes::MIN_BLOCK_SHIFT;
...
/// mirroring [`AllocBitmap::init_in_place`](crate::alloc_core::alloc_bitmap::AllocBitmap::init_in_place)'s
