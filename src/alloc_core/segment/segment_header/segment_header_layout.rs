...
impl Layout {
    ...
    /// Offset of the per-segment [`AllocBitmap`](crate::alloc_core::alloc_bitmap::AllocBitmap)
    ...
    /// [`MagazineBitmap`](crate::alloc_core::magazine_bitmap::MagazineBitmap), an
    ...
    pub(crate) const fn magazine_bitmap_off() -> usize {
        align_up_const(
            Self::alloc_bitmap_off() + crate::alloc_core::alloc_bitmap::AllocBitmap::FOOTPRINT,
            8,
        )
    }
    ...
    pub(crate) const fn remote_ring_off() -> usize {
        align_up_const(
            Self::magazine_bitmap_off()
                + crate::alloc_core::magazine_bitmap::MagazineBitmap::FOOTPRINT,
            4,
        )
    }
    ...
    pub(crate) const fn gen_table_off() -> usize {
        ...
        Self::remote_ring_off() + crate::alloc_core::remote_free_ring::FOOTPRINT
    }
    ...
    ///    [`crate::alloc_core::remote_free_ring::FOOTPRINT`]).
    ...
    pub(crate) const fn primordial_hash_off() -> usize {
        align_up_const(
            Self::primordial_registry_off() + crate::alloc_core::segment_table::REGISTRY_FOOTPRINT,
            8,
        )
    }
    ...
    pub(crate) const fn primordial_free_list_off() -> usize {
        align_up_const(
            Self::primordial_hash_off() + crate::alloc_core::segment_table::HASH_FOOTPRINT,
            4,
        )
    }
    ...
    /// [`LAZY_FIRST_CHUNK`](crate::alloc_core::alloc_core_small::LAZY_FIRST_CHUNK) of
    ...
    pub(crate) fn lazy_initial_commit(meta_end: usize, page_size: usize) -> usize {
        ...
        align_up(
            meta_end + crate::alloc_core::alloc_core_small::LAZY_FIRST_CHUNK,
            page_size,
        )
    }
