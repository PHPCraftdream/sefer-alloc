...
#[cfg(feature = "alloc-decommit")]
pub(in crate::alloc_core) const LARGE_CACHE_SLOTS: usize = 8;
...
const _: () = assert!(
    LARGE_CACHE_SLOTS + super::super::large_cache_extended::LARGE_CACHE_EXTENDED_SLOTS
        <= u64::BITS as usize
);
...
#[cfg(feature = "alloc-decommit")]
pub(in crate::alloc_core) const LARGE_CACHE_SIZE_FACTOR: usize = 2;
...
#[cfg(feature = "alloc-decommit")]
#[derive(PartialEq)]
pub(in crate::alloc_core) struct LargeCacheDecayConfig {
    /// Fraction of the excess to release per tick, in basis points.
    /// 1000 = 10%, 5000 = 50%, 10000 = 100%.
    pub(in crate::alloc_core) decay_rate_bp: u32,
    /// Minimum wall-clock interval between consecutive decay ticks.
    pub(in crate::alloc_core) decay_interval: core::time::Duration,
    ...
    pub(in crate::alloc_core) headroom_bytes: usize,
}
...
pub(in crate::alloc_core) struct CachedLarge {
    ...
    pub(in crate::alloc_core) reserved_capacity: usize,
    ...
    pub(in crate::alloc_core) seq: u64,
}
...
pub struct AllocCore {
    ...
    pub(in crate::alloc_core) table: SegmentTable,
    ...
    pub(in crate::alloc_core) small_cur: *mut u8,
    ...
    pub(in crate::alloc_core) cached_numa_node: Option<u32>,
    ...
    /// `cached_numa_node`.
    #[cfg(feature = "numa-aware")]
    pub(in crate::alloc_core) numa_node_hits_since_refresh: u32,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache: [Option<CachedLarge>; LARGE_CACHE_SLOTS],
    ...
    /// 64.
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache_occupied: u64,
    ...
    #[cfg(feature = "large-cache-extended")]
    pub(in crate::alloc_core) large_cache_extension_vm:
        Option<super::super::sidecar::AccountedSidecar>,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache_used_bytes: usize,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache_seq: u64,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) decay_config: LargeCacheDecayConfig,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) last_decay_tick: Option<std::time::Instant>,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache_decay_op_count: u32,
    ...
    /// решение №2).
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache_mode: LargeCacheMode,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) large_cache_hits: LargeCacheHitCounter,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) pool_tail: *mut u8,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) pooled_count: u32,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) pool_cap: u32,
    ...
    #[cfg(feature = "alloc-decommit")]
    pub(in crate::alloc_core) last_pool_decay_tick: Option<std::time::Instant>,
    ...
    /// accessor.
    #[cfg(feature = "alloc-segment-directory")]
    pub(in crate::alloc_core) directory_sidecar:
        *mut super::super::segment_directory::SegmentDirectory,
    ...
    #[cfg(feature = "alloc-segment-directory")]
    pub(in crate::alloc_core) directory_sidecar_vm: Option<super::super::sidecar::AccountedSidecar>,
