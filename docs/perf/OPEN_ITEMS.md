...
61. **[D] `tagged-index-stack` store-elision candidate in the `push_index`
    ...
    - **Current-number-or-verdict:** `store_elided` changes only
      ...
      run-25 remediation HEAD `4a410012fcff3ad308de988824462947e49f7ebf`,
      tree `4f5ea26d95352b3aaf689061a0252268062f68bc`, digest
      `14909a43f6853f2a43137c25fc061741b7dc4e3654a3d7332ad2b58546a490c2`,
      artifact commit `1cc7291`, and host receipt hash remains
    ...
    - **Evidence:** `docs/perf/TIS_LINK_ORDERING_WEAK_CAS_GATE.md`; source-input
      ...
      `14909a43f6853f2a43137c25fc061741b7dc4e3654a3d7332ad2b58546a490c2`;
      current codegen artifact commit `1cc7291`; and the historical ODB/HS
...
62. **[D] `tagged-index-stack` link-cell ordering (P3-1) wall-clock A/B.**
    ...
    - **Current-number-or-verdict:** authoritative codegen is source-input
      ...
      results. The current artifact commit is `1cc7291`; the host receipt
    ...
    - **Evidence:** `docs/perf/TIS_LINK_ORDERING_WEAK_CAS_GATE.md` and its two
      current codegen CSVs/raw logs/asm; source HEAD `4a410012fcff3ad308de988824462947e49f7ebf`,
      tree `4f5ea26d95352b3aaf689061a0252268062f68bc`, digest
      `14909a43f6853f2a43137c25fc061741b7dc4e3654a3d7332ad2b58546a490c2`;
      artifact commit `1cc7291`; and historical ODB/HS commits `c00087f`,
