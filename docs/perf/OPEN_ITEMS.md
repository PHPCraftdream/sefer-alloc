...
61. **[D] `tagged-index-stack` store-elision candidate in the `push_index`
    ...
    - **Current-number-or-verdict:** `store_elided` changes only
      ...
      run-25 remediation HEAD `77fafc36234af838749a70c3ae5cb7c2ea877ee6`,
      tree `69ed043e90822c4bedda72fd9cf2ab64e3507fa1`, digest
      `6295e69d5c983fc429eeaacf6f3accf2d1a6e5403772628096be2e3e9fedd1a6`,
      artifact commit `0203577`, and host receipt hash remains
      ...
      natural ARM has not been executed.
    ...
    - **Evidence:** `docs/perf/TIS_LINK_ORDERING_WEAK_CAS_GATE.md`; source-input
      ...
      `6295e69d5c983fc429eeaacf6f3accf2d1a6e5403772628096be2e3e9fedd1a6`;
      current codegen artifact commit `0203577`; and the historical ODB/HS
...
62. **[D] `tagged-index-stack` link-cell ordering (P3-1) wall-clock A/B.**
    ...
    - **Current-number-or-verdict:** authoritative codegen is source-input
      ...
      results. The current artifact commit is `0203577`; the host receipt
    ...
    - **Evidence:** `docs/perf/TIS_LINK_ORDERING_WEAK_CAS_GATE.md` and its two
      current codegen CSVs/raw logs/asm; source HEAD `77fafc36234af838749a70c3ae5cb7c2ea877ee6`,
      tree `69ed043e90822c4bedda72fd9cf2ab64e3507fa1`, digest
      `6295e69d5c983fc429eeaacf6f3accf2d1a6e5403772628096be2e3e9fedd1a6`;
      artifact commit `0203577`; and historical ODB/HS commits `c00087f`,
