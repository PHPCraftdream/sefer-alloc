...
a test file, and a reproducible command. **260 integration test files** ship
...
|---|---|---|
| Unit / integration tests | Construction, edge cases, end-to-end behaviour | `tests/*.rs` (260 files) |
