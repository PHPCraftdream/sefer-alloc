...
a test file, and a reproducible command. **267 integration test files** ship
...
|---|---|---|
| Unit / integration tests | Construction, edge cases, end-to-end behaviour | `tests/*.rs` (267 files) |
