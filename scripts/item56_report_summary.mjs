...
const IDENTITIES = [
  ...
  ['5289c66:src/alloc_core/segment/segment_table/mod.rs', 'counterfactual A\': 5289c66 side of the swap'],
  ['5289c66^:src/alloc_core/segment/segment_table/mod.rs', "counterfactual A': reverted-to blob"],
  ['5289c66^:src/alloc_core/alloc_core/', "counterfactual A': reverted-to blob"],
  ['5289c66^:src/alloc_core/alloc_core/alloc_core_core_diag/', "counterfactual A': reverted-to blob"],
